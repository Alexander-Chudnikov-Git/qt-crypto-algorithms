...
namespace DEFAULTS
{
	...
	constexpr auto d_application_default_panel = APP::PanelType::TEST_RSA;

	constexpr auto d_logger_name				= "global_logger";
	constexpr auto d_logger_control_panel		= "control_panel";
	constexpr auto d_logger_user_panel			= "user_panel";
	constexpr auto d_logger_settings_manager	= "settings";
	constexpr auto d_logger_translation_manager = "language";
	constexpr auto d_logger_exchanger			= "exchanger";
	constexpr auto d_logger_protocol			= "protocol";
	constexpr auto d_logger_rsa					= "rsa";
	constexpr auto d_logger_dh					= "diffie_hellman";
